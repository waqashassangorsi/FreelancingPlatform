						...
						<div class="col-12 col-sm-12 col-md-12 col-lg-5">
							<div class="wt-bannerimages">
								<figure class="wt-bannermanimg" data-tilt>
									<img src="{{asset('frontend/images/bannerimg/img-01.png')}} " alt="img description">
									<img src="{{asset('frontend/images/bannerimg/img-02.png')}}" class="wt-bannermanimgone" alt="img description">
									<img src="{{asset('frontend/images/bannerimg/img-03.png')}}" class="wt-bannermanimgtwo" alt="img description">
								</figure>
							</div>
						</div>
							...
							<div class="wt-categoryexpl">
								<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
									<div class="wt-categorycontent">
										<figure><img src="{{asset('frontend/images/categories/img-01.png')}}" alt="image description"></figure>
								...
								<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
									<div class="wt-categorycontent">
										<figure><img src="{{asset('frontend/images/categories/img-08.png')}}" alt="image description"></figure>
										<div class="wt-cattitle">
								...
								<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
									<div class="wt-categorycontent">
										<figure><img src="{{asset('frontend/images/categories/img-02.png')}}" alt="image description"></figure>
										<div class="wt-cattitle">
								...
								<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
									<div class="wt-categorycontent">
										<figure><img src="{{asset('frontend/images/categories/img-03.png')}}" alt="image description"></figure>
										<div class="wt-cattitle">
								...
								<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
									<div class="wt-categorycontent">
										<figure><img src="{{asset('frontend/images/categories/img-04.png')}}" alt="image description"></figure>
										<div class="wt-cattitle">
								...
								<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
									<div class="wt-categorycontent">
										<figure><img src="{{asset('frontend/images/categories/img-05.png')}}" alt="image description"></figure>
										<div class="wt-cattitle">
								...
								<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
									<div class="wt-categorycontent">
										<figure><img src="{{asset('frontend/images/categories/img-06.png')}}" alt="image description"></figure>
										<div class="wt-cattitle">
								...
								<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
									<div class="wt-categorycontent">
										<figure><img src="{{asset('frontend/images/categories/img-07.png')}}" alt="image description"></figure>
										<div class="wt-cattitle">
						...
						<div class="row">
							<div class="col-12 col-sm-12 col-md-6 col-lg-6 float-left">
								<figure class="wt-mobileimg">
									<img src="{{asset('frontend/images/mobile-img.png')}}" alt="img description">
								</figure>
							</div>
							<div class="col-12 col-sm-12 col-md-6 col-lg-6 float-left">
										...
										<ul class="wt-appicon">
											<li>
												<a href="javascript:void(0)">
													<figure><img src="{{asset('frontend/images/app-icon/img-01.png')}}" alt="img description"></figure>
												</a>
											</li>
											<li>
												<a href="javascript:void(0)">
													<figure><img src="{{asset('frontend/images/app-icon/img-02.png')}}" alt="img description"></figure>
												</a>
											</li>
										</ul>
									</div>
