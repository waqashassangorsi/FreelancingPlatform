					...
					<div id="wt-verticalscrollbar" class="wt-verticalscrollbar">
						<div class="wt-companysdetails wt-usersidebar">
							<figure class="wt-companysimg">
								<img src="{{asset('/frontend/images/sidebar/img-01.jpg')}}" alt="img description">
							</figure>
							<div class="wt-companysinfo">
								<figure><img src="{{asset('frontend/images/sidebar/img-02.jpg')}}" alt="img description"></figure>
								<div class="wt-title">
						...
						<nav id="wt-navdashboard" class="wt-navdashboard">
							<ul>
								<li class="menu-item-has-children wt-active">
									...
									<ul class="sub-menu">
										<li class="wt-active"><hr><a href="{{url('/dashboard')}}">Insights</a></li>
										<li><hr><a href="{{url('/insightsuser')}}">Insights User</a></li>
									</ul>
								</li>
								<li>
								...
								<li class="wt-notificationicon menu-item-has-children">
									...
									<ul class="sub-menu">
										<li><hr><a href="{{url('/messages')}}">Messages</a></li>
