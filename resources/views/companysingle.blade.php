					...
					<div class="row justify-content-md-center">
						<div class="col-xs-12 col-sm-12 col-md-8 push-md-2 col-lg-6 push-lg-3">
							...
							<ol class="wt-breadcrumb">
								...
								<li class="wt-active">Comapny Detail</li>
							</ol>
							</div>
						</div>
					</div>
										...
										<aside id="wt-sidebar" class="wt-sidebar">
											<div class="wt-proposalsr wt-proposalsrvtwo">
												...
												<div class="wt-clicksavearea">
													...
													<a href="javascrip:void(0);" class="wt-clicksavebtn"><i class="far fa-heart"></i> Click to Follow</a>
												</div>
											</div>
											<div class="wt-widget">
												...
												<div class="wt-widgetcontent wt-comfollowers wt-verticalscrollbar">
													<ul>
														...
														<li>
															<a href="javascript:void(0);">
																<span><img src="images/followers/img-03.jpg" alt="img description"></span>
																<span>Sophie Roman</span>
															</a>
														</li>
														<li>
															<a href="javascript:void(0);">
																<span><img src="images/followers/img-04.jpg" alt="img description"></span>
																<span>Danica Letourneau</span>
															</a>
														</li>
														<li>
															<a href="javascript:void(0);">
																<span><img src="images/followers/img-05.jpg" alt="img description"></span>
																<span>Arturo Doolin</span>
															</a>
														</li>
														<li>
															<a href="javascript:void(0);">
																<span><img src="images/followers/img-06.jpg" alt="img description"></span>
																<span>Dominique Llanos</span>
															</a>
														</li>
														<li>
															<a href="javascript:void(0);">
																<span><img src="images/followers/img-07.jpg" alt="img description"></span>
																<span>Fannie Touchet</span>
															</a>
														</li>
														<li>
															<a href="javascript:void(0);">
